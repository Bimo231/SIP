...
namespace SIP
{
    public partial class frmPeminjaman : Form
    {
        ...
        {
            sambung = new koneksi();
            sql = "insert into transaksi(id_transaksi,id_user,id_buku,tgl_peminjaman,tgl_kembali) value('" + transaksi.Text + "','" + nimBox.Text + "','" + isbnBox.Text + "','" + tglPinjam.Text + "','" + deadline.Text + "')";
        ...
        private void tglPinjam_ValueChanged(object sender, EventArgs e)
        {
