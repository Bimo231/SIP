...
namespace SIP
{
    ...
    public partial class frmPengembalian : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE `transaksi` SET `id_user`='"+this.nimBox.Text+"',id_buku ='"+this.isbnBox.Text+"',`tgl_dikembalikan`='"+this.tglBalik.Text+ "' Where  `id_transaksi`='" + this.TransaksiBox.Text + "' ";
            try
            {
                sambungan.buka();
        ...
        private void nimBox_TextChanged(object sender, EventArgs e)
        {
